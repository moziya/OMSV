...
mkdir temp
./OMSV -inputLabel 12878 -outputFolder ./ -SVoutputFile Indel -chrMapFile hg38_r.cmap -optAlignFile data/NA12878_700bp_hg38_combRefOMB2.oma -optTempFolder temp/
rm -f *_List.txt
./postFilter.sh SV_result/12878Indel_2000.osv 2000

echo "2. Start to call mixed indels"
./OMSV_mixedIndel -inputLabel 12878 -outputFolder ./ -SVoutputFile Mixed_indel -chrMapFile hg38_r.cmap -optAlignFile data/NA12878_700bp_hg38_combRefOMB2.oma -optTempFolder temp/
...
echo "./CNV_caller.sh data/NA12878_700bp_hg38_combRefOMB2.oma hg38_r.cmap . 12878"
